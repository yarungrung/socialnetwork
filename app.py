...
# ==========================================
# 🎛️ 側邊欄控制面板 (最高層級，進網頁絕對秒彈出！)
# ==========================================
st.sidebar.header("🎯 災害情境自訂面板")

disaster_name = st.sidebar.text_input("1. 輸入特定災害名稱", value="突發性空間失能事件")
...
if st.sidebar.button("🚀 開始進行空間失能模擬") or st.button("🔥 執行單次空間失能評估"):
    with st.spinner(f"⏳ 正在分析【{disaster_name}】對臺中市路網的木桶短板衝擊..."):
        ...
        st.success(f"🎉 【{disaster_name}】模擬計算完成！已成功輸出單次評估結果。")
